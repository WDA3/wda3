...
<body style="opacity: 1; background-color: #f2f2f2;">
	<p style="white-space: inherit; text-align: center; font-size: 81px; line-height: 117px; margin-bottom: 50px;" data-size-leading-linked="true" data-size-leading-ratio="1.4444444444444444">
		<span style="color: black;">Bulletin Board </span>
	</p>
	<form style="margin: 0 auto; width:250px;" method="post" action="/login">
		<input type="text" placeholder="ID" name="id" value="" style="height: 30px; width: 286px; margin-bottom: 20px; background-color: rgb(247, 247, 247); border-radius: 0px; box-shadow: rgb(0, 0, 0) 0px 0px 0px 0px inset; font-family: Roboto; font-style: normal; font-weight: 400; letter-spacing: 0px; font-size: 18px;"/>
		<input type="password" placeholder="PASSWORD" value="" name="password" style="height: 30px; width: 286px; margin-bottom: 20px; background-color: rgb(247, 247, 247); border-radius: 0px; box-shadow: rgb(0, 0, 0) 0px 0px 0px 0px inset; font-family: Roboto; font-style: normal; font-weight: 400; letter-spacing: 0px; font-size: 18px;">
