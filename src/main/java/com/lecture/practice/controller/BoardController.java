...
public class BoardController {
	...
	public ModelAndView board(Model model, BoardVO boardVO) throws Exception {
		return board_list(model, boardVO);
	}
	...
	public ModelAndView board_detail(Model model, BoardVO boardVO) throws Exception {
		...
		if(boardVO.getId().equals("")) { return is_login(model, boardVO); }
	...
	private ModelAndView is_login(Model model, BoardVO boardVO) throws Exception {
	...
	private ModelAndView board_list(Model model, BoardVO boardVO) throws Exception {
		List<BoardVO> list = boardService.getBoardList(boardVO);
